...
def device_get_all_by_service_id(context, service_id):
    ...
    return IMPL.device_get_all_service_id(context, service_id)

def device_get_all_by_state(context, state):
    """get all devices by state"""
    return IMPL.device_get_all_state(context, state)
...
#bellow is about the operation on Monitor user capacity management
def monitor_capacity_manage_get(context, monitor_capacity_manage_id):
    """get a user according to specify monitor_capacity_manage_id"""
    return IMPL.monitor_capacity_manage_get(context, monitor_capacity_manage_id)

def monitor_capacity_manage_get_all(context):
    """get all Monitor users"""
    return IMPL.monitor_capacity_manage_get_all(context)

def monitor_capacity_manage_create(context, values):
    """create a Monitor user from the values dictionary"""
    return IMPL.monitor_capacity_manage_create(context, values)

def monitor_capacity_manage_update(context, monitor_capacity_manage_id, values):
    """update a Monitor user from the values dictionary"""
    return IMPL.monitor_capacity_manage_update(context, monitor_capacity_manage_id, values)

def monitor_capacity_manage_delete(context, monitor_capacity_manage_id):
    """delete a Monitor user according to specify monitor_capacity_manage_id"""
    return IMPL.monitor_capacity_manage_delete(context, monitor_capacity_manage_id)
