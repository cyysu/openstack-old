...
if not os.getenv('SPHINX_DEBUG'):
    extensions += ['ext.monitor_autodoc']
...
# built documents.
#
from monitor.version import version_info
...
modindex_common_prefix = ['monitor.']
...
man_pages = [
    ('man/monitor-manage', 'monitor-manage', u'Cloud controller fabric',
     [u'OpenStack'], 1)
]
