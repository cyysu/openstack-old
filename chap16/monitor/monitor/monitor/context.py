...
"""RequestContext: context for requests that persist through all of monitor."""

import copy
import uuid

from monitor.openstack.common import local
...
class RequestContext(object):
    ...
    # tenant/user whereas the Vsm version uses project_id/user_id. We need
