...
def upgrade(migrate_engine):
    ...
    devices = Table(
        ...
        Column('total_capacity_gb', Float(), nullable=False),
        Column('free_capacity_gb', Float()),
        Column('device_type', String(length=255)),
        ...
        Column('state', String(length=255), default="down"),
    )

    try:
        devices.create()
    except Exception:
        LOG.info(repr(devices))
