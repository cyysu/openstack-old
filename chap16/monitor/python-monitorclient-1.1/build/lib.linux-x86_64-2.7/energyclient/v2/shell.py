...
def do_create(cs, args):
    ...
    info = dict()
    monitor = cs.monitors.get(info['id'])
    info.update(monitor._info)
...
@utils.arg('monitor',
           metavar='<monitor>',
           help='ID of the monitor to delete.')
@utils.service_type('monitor')
...
@utils.arg('monitor',
           metavar='<monitor>',
           help='ID of the monitor to rename.')
@utils.arg('name',
           nargs='?',
           metavar='<name>',
           help='New name for the monitor.')
...
def do_snapshot_list(cs, args):
    ...
    utils.print_list(snapshots,
                     ['ID', 'ServiceManage ID', 'Status', 'Name', 'Size'])
