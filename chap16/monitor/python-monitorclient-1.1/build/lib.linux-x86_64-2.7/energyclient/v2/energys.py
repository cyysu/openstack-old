...
"""ServiceManage interface (v2 extension)."""
...
class ServiceManage(base.Resource):
    ...
    def update(self, **kwargs):
        """Update the name or description for this monitor."""
...
class ServiceManageManager(base.ManagerWithFind):
    ...
    def create(self, size, snapshot_id=None, source_volid=None,
        ...
        :param description: Description of the monitor
    ...
    def list(self, detailed=True, search_opts=None):
        ...
        return self._list("/monitors%s%s" % (detail, query_string),
                          "monitors")
    ...
    def update(self, monitor, **kwargs):
        """Update the name or description for a monitor.
