...
class VsmClientArgumentParser(argparse.ArgumentParser):

    def __init__(self, *args, **kwargs):
        super(VsmClientArgumentParser, self).__init__(*args, **kwargs)
...
class OpenStackVsmShell(object):
    ...
    def main(self, argv):
        print 'JIYOU in OpenStackVsmShell.main() in shell.py'
        ...
        try:
            ...
            raise exc.CommandError("Invalid OpenStack Vsm credentials.")
...
def main():
    ...
    try:
        OpenStackVsmShell().main(map(strutils.safe_decode, sys.argv[1:]))
