...
from monitor.openstack.common.scheduler import filters
from monitor.openstack.common.scheduler.filters import extra_specs_ops
...
class CapabilitiesFilter(filters.BaseHostFilter):
    """HostFilter to work with resource (instance & servicemanage) type records."""
    ...
    def host_passes(self, host_state, filter_properties):
        ...
        # Note(zhiteng) Currently only Vsm and Nova are using
