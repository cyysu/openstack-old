...
global_opts = [
    ...
    cfg.ListOpt('glance_api_servers',
                ...
                help='A list of the glance api servers available to monitor '
                     '([hostname|ip]:port)'),
    ...
    cfg.StrOpt('operation_topic',
               default='monitor-operation',
               help='the topic operation nodes listen on'),
    cfg.StrOpt('scheduler_topic',
               default='monitor-scheduler',
               help='the topic scheduler nodes listen on'),
    cfg.StrOpt('publisher_topic',
               default='monitor-publisher',
               help='the topic publisher nodes listen on'),
    cfg.StrOpt('servicemanage_topic',
               default='monitor-servicemanage',
               help='the topic servicemanage nodes listen on'),
    cfg.StrOpt('backup_topic',
               default='monitor-backup',
               help='the topic servicemanage backup nodes listen on'),
    ...
    cfg.StrOpt('backup_manager',
               default='monitor.backup.manager.BackupManager',
               help='full class name for the Manager for servicemanage backup'),
    ...
    cfg.StrOpt('agent_manager',
               default='monitor.agent.manager.AgentManager',
               help='full class name for the Manager for Conductor'),
    ...
    cfg.StrOpt('backup_api_class',
               default='monitor.backup.api.API',
               help='The full class name of the servicemanage backup API class'),
